...
def _run_cnn_send(generator, sim_specs, parameters, summed_gradients=None):
...
@input_fields(["initial_parameters"])
...
def mnist_training_sim(H, _, sim_specs, info):
    ...
    _run_cnn_send(generator, sim_specs, H["initial_parameters"][0])
